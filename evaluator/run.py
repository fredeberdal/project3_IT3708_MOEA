...
optimalFolder = path + "/optimal_segments/76002"  # you may have to specify the complete path
studentFolder = path + "/student_segments/76002/black/" # you may have to specify the complete path
